        ...
        while True:
            ...
            try:
                ...
                while True:
                    ...
                    # TODO: Send the data you received back to the client,
                    #  log the fact using the print statement here.  It will
                    #  help in debugging problems.

                    conn.sendall(data.encode('utf8'))
                    print('sent "{0}"'.format(data.decode('utf8')))
                    
                    # TODO: Check here to see whether you have received the
                    #  end of the message. If you have, then break from the
                    #  `while True` loop.
                    ...
                    if amount_received < buffer_size:
                        break
